...
.mobile-screen-footer p {
    
    text-align: center;
}

.mobile-screen-footer img {
    width: 44px;
}
					...
					<div class="footer-card-main">
						...
						<div class="footer-links-item">
							<ul>
								...
								<li><a href="seller-policy.php">Seller Policy</a></li>
								<li><a href="learning-guides.php">Learning Guides</a></li>
								<li><a href="merchant-penalties.php">Merchant Penalties</a></li>
							</ul>
...
<div class="modal fade" id="myModal">
	...
	<footer class="mobile-screen-footer">
        <p>
		<a href="javascript:void(0)" class="btn-quote" data-toggle="modal" data-target="#myModal" style="width: 50%;border: 1px solid #eb252a;">START SELLING</a>
		<a href="https://sadar24.com/users/login" class="btn-quote"  style="width: 50%;float: right;border: 1px solid #eb252a;">LOGIN</a>
		</p>
    </footer>
<div id="mybutton">
<a href="https://sadar24.com/users/login" class="feedback btn-quote">Login</a>
</div>
