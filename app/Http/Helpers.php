...
if (!function_exists('single_price')) {
    ...
    {
        return format_price(convert_price(round($price)));
    }
}

//formats price to home default price with convertion
if (!function_exists('single_price_with_decimal')) {
    function single_price_with_decimal($price)
    {
...
if (!function_exists('home_base_price')) {
    function home_base_price($product, $formatted = true)
    {
        ...
        // }
        $price += $tax;
        return $formatted ? format_price(convert_price(round($price))) : $price;
    }
}
...
if (!function_exists('api_asset')) {
    ...
    {
        if (($asset = DB::table('uploads')->find($id)) != null) {
