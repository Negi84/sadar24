...
class SupportTicketController extends Controller
{
    ...
    {
		$order_id =null;
        $tickets = Ticket::where('user_id', Auth::user()->id)->orderBy('id', 'desc')->paginate(9);
        return view('frontend.user.support_ticket.index', compact('tickets','order_id'));
    }
    ...
    public function store(Request $request)
    {
        //dd();		
        $ticket = new Ticket;
        $ticket->code = Ticket::latest()->first() != null ? Ticket::latest()->first()->code + 1 : 1000;
    ...
    public function admin_store(Request $request)
    {
		...
		$ticket_reply->ticket->created_at = $request->created_at;
