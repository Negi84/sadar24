...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
    ...
    Route::get('/categories-refund-request-config', 'CategoryController@return_categories_index')->name('categories_refund_time_config');
    Route::get('/categories-refund-policy/edit/{id}', 'CategoryController@return_categories_edit')->name('categories_refund_policy.edit');
    Route::Post('/categories_refund_policy/update/{id}', 'CategoryController@return_categories_update')->name('categories_refund_policy.update');
...
Route::post('refund-request-vendor-approval', 'RefundRequestController@request_approval_vendor')->name('vendor_refund_approval');
