...
Route::prefix('v2/auth')->group(function () {
    ...
    Route::post('send-login-otp', 'Api\V2\AuthController@sendLoginOtp');
    Route::post('mobile-login', 'Api\V2\AuthController@mobileLogin');
...
Route::prefix('v2')->group(function () {
    ...
    Route::get('home', 'Api\V2\HomeController@home');
    ...
    Route::get('all-sub-categories/{id}', 'Api\V2\SubCategoryController@sub_category')->name('subCategories.sub_category');
    ...
    Route::get('products/top-from-seller', 'Api\V2\ProductController@topFromSeller')->name('products.topFromSeller');
    ...
    Route::get('cart', 'Api\V2\CartController@cart')->middleware('auth:api');
    Route::get('emptycart', 'Api\V2\CartController@emptycart')->middleware('auth:api');
    Route::get('cart-summary/{user_id}', 'Api\V2\CartController@summary')->middleware('auth:api');
    Route::get('cart-count', 'Api\V2\CartController@cartCount')->middleware('auth:api');
    Route::post('carts/process', 'Api\V2\CartController@process')->middleware('auth:api');
    Route::post('carts/add', 'Api\V2\CartController@addToCart')->middleware('auth:api');
    Route::get('carts/reorder/{id}', 'Api\V2\CartController@reOrder')->middleware('auth:api');
    Route::get('removeFromCart/{cart_id}', 'Api\V2\CartController@removeFromCart')->middleware('auth:api');
    ...
    Route::get('checkout', 'Api\V2\CheckoutController@checkout')->middleware('auth:api');
    Route::post('order_place', 'Api\V2\CheckoutController@order_place')->middleware('auth:api');
    Route::post('payment', 'Api\V2\RazorpayController@payment')->middleware('auth:api');

    Route::get('cancel_order/{id}', 'Api\V2\OrderController@cancel')->middleware('auth:api');
    ...
    Route::get('/product/{id}', 'Api\V2\ProductController@product')->name('product');
    ...
    Route::post('refund-request/send/{id}', 'Api\V2\RefundRequestController@send')->middleware('auth:api');
    ...
    Route::any('razorpay/payment', 'Api\V2\RazorpayController@payment')->name('api.razorpay.paymentpay');
...
Route::post('v1/delhivery-webhook', 'DelhiveryController@getWebhookResponse');