...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::get('/featured_categories', 'CategoryController@featured_categories')->name('categories.featured_categories');
    Route::get('/categories/edit/{id}', 'CategoryController@edit')->name('categories.edit');
    Route::get('/categories/destroy/{id}', 'CategoryController@destroy')->name('categories.destroy');
    Route::post('/categories/featured', 'CategoryController@updateFeatured')->name('categories.featured');

    Route::resource('filters', 'filtersController');
    // Route::get('/featured_categories', 'filtersController@featured_categories')->name('categories.featured_categories');
    Route::get('/filters/edit/{id}', 'filtersController@edit')->name('filters.edit');
    Route::get('/filters/destroy/{id}', 'filtersController@destroy')->name('filters.destroy');
    ...
    Route::get('/products/pilot_all', 'ProductController@all_pilot_products')->name('products.pilot.all');
    ...
    Route::get('registered_customers', 'CustomerController@registered_index')->name('customers.registered_index');
    Route::get('guest_customers', 'CustomerController@guest_index')->name('customers.guest_index');
	...
	Route::get('customers/purchase_history/{id}', 'CustomerController@customer_purchase_history')->name('customers.purchase_history');
	...
	Route::get('/sla_charge', 'BusinessSettingsController@sla_charge')->name('business_settings.sla_charge');
    Route::post('/sla_charge_update', 'BusinessSettingsController@sla_charge_update')->name('business_settings.sla_charge.update');
    ...
    Route::group(['prefix' => 'mobileapp'], function() {
        Route::get('/home_layout', 'MobileAppController@home_layout')->name('mobileapp.home_layout');
    });
    ...
    Route::get('/seller_account', 'SellerController@seller_account')->name('seller_account.index');	
	Route::post('/bulk-order-pay', 'SellerController@bulk_order_pay')->name('bulk-order-pay');	
	Route::get('/seller_account/commission/{id}/edit', 'CommissionController@seller_account_commission_edit')->name('seller_account.commission.edit');
	Route::get('/seller_account/destroy/{id}', 'CommissionController@destroy')->name('seller_account.commission.destroy');   
	...
	// New Reports 
	Route::get('/sales_reports', 'ReportController@sales_reports')->name('sales_reports.index');	
    Route::get('/seller_registration_report', 'ReportController@seller_registration_report')->name('seller_registration_report.index');
	Route::get('/customer_registration_report', 'ReportController@customer_registration_report')->name('customer_registration_report.index');
	Route::get('/registered_customer_report', 'ReportController@registered_customer_report')->name('registered_customer_report.index');
	Route::get('/guest_customer_report', 'ReportController@guest_customer_report')->name('guest_customer_report.index');
	Route::get('/best_performing_seller_report', 'ReportController@best_performing_seller_report')->name('best_performing_seller_report.index');
	Route::get('/best_selling_products_report', 'ReportController@best_selling_products_report')->name('best_selling_products_report.index');	
	Route::get('/coupon_code_utilization_report', 'ReportController@coupon_code_utilization_report')->name('coupon_code_utilization_report.index');
	
	Route::get('/sla-breach-report','ReportController@sla_breach_report')->name('sla_breach_report.index');
    Route::get('/recently-viewed-report','ReportController@recently_viewed_report')->name('recently_viewed_report.index');
	
	 //Export Section
	
	Route::get('/admin/order-bulk-export', 'OrderController@all_orders')->name('order_bulk_export.index');
	Route::get('/admin/seller-reg-export', 'ReportController@seller_registration_report_export')->name('seller_reg_export.index');
    ...
    Route::get('/bulk-reviews', 'ReviewController@bulk_review_index')->name('bulk.reviews.index');
    ...
    //Bulk product sheet route
    // Route::get('/review_bulk_sheet_upload','ProductBulkUploadController@review_bulk_sheet_upload')->name('bulk.review.sheet.upload');
    Route::post('/reviewed-bulk-product-upload', 'ProductBulkUploadController@store_reviewed_bulk_product_sheet')->name('reviewed_bulk_product_upload');
