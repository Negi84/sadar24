...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        <div class="col-md-6">
            <h1 class="h3">{{translate('Set Categories Refund Policy')}}</h1>
        </div>
...
<div class="card">
    <div class="card-header d-block d-md-flex">
        <h5 class="mb-0 h6">{{ translate('Child Categories') }}</h5>
        ...
        <table class="table aiz-table mb-0">
            <thead>
                <tr>
					...
					<th data-breakpoints="lg">{{translate('GST')}}</th> --}}
					<th data-breakpoints="lg">{{translate('Return Policy')}}</th>
            ...
            <tbody>
                @foreach($categories as $key => $category)
                    <tr>
						...
						<td>{{ $category->gst }} %</td> --}}
						<td>{{ $category->return_policy }} Days Policy</td>
                        {{-- <td>
                         ...
                         --}}
                        <td class="text-right">
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('categories_refund_policy.edit', ['id'=>$category->id, 'lang'=>env('DEFAULT_LANGUAGE')] )}}" title="{{ translate('Edit') }}">
