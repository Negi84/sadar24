    ...
    <div class="col-lg-8 mx-auto">
        <div class="card">
            <div class="card-body p-0">
                ...
                <form class="p-4" action="{{ route('categories_refund_policy.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="name" disabled="" value="{{ $category->getTranslation('name', $lang) }}" class="form-control" id="name" placeholder="{{translate('Name')}}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">{{translate('Parent Category')}}</label>
                        <div class="col-md-9">
                            <select class="select2 form-control aiz-selectpicker" disabled="" name="parent_id" data-toggle="select2" data-placeholder="Choose ..."data-live-search="true" data-selected="{{ $category->parent_id }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="number" name="return_policy" value="{{ $category->return_policy }}" class="form-control" id="return_policy" placeholder="{{translate('Return Policy')}}">
                            <small>{{translate('0 Days means not returnable child category!')}}</small>
                        </div>
                    </div>
                    {{-- <div class="form-group row">
					...
					<div class="form-group row">
						<label class="col-md-3 col-form-label">{{translate('GST Percentage')}}</label>
						<div class="col-md-9 input-group">
							<input type="number" lang="en" min="0" step="0.01" id="gst" name="gst" value="{{ $category->gst }}" class="form-control">
