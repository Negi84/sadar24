                    ...
                    <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-8 mx-auto">
                        <div class="card">
                            <div class="text-center pt-4">
                                <h1 class="h4 fw-600">
                                    {{ translate('Enter OTP Number to Login.')}}
                                </h1>
                            </div>

                            <div class="px-4 py-3 py-lg-4">
                                <div class="">
                                    <form class="form-default" role="form" action="{{ route('user.otp') }}" method="POST">
                                        @csrf
                                        
                                            <div class="form-group phone-form-group mb-1">
                                                
												<input id="phone" type="hidden" class="form-control" name="phone" value="{{ $phone }}" required autofocus>
												<input id="session_id" type="hidden" class="form-control" name="session_id" value="{{ $session_id }}" autofocus>
												<input id="otp" type="text" class="form-control" name="otp" value="{{ old('otp') }}" placeholder="Enter OTP Number" required autofocus>
												@if (session('errors'))
