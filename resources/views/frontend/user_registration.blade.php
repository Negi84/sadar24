                                    ...
                                    <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST">
                                        ...
                                        @if (addon_is_activated('otp_system'))
                                            <div class="form-group phone-form-group mb-1">
                                                <input type="text" id="phone-code" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" value="{{ old('phone') }}" placeholder="" name="phone" autocomplete="off" maxlength="10" minlength="10" onkeypress="phoneno()">
                                            </div>
                                        ...
                                        @else
											<div class="form-group phone-form-group">
                                                <input type="text" id="phone-code" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" value="{{ old('phone') }}" placeholder="" name="phone" autocomplete="off" required maxlength="10" minlength="10" onkeypress="phoneno()">
                                            </div>
                                            <div class="form-group">
