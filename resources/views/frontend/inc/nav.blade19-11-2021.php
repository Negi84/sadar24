			...
			<form action="{{ route('search') }}" method="GET" class="stop-propagation">
				<div class="d-flex position-relative align-items-center">
					...
					<div class="input-group ui-widget">
						<input type="text" id="tags" class="form-control"  name="keyword" @isset($query)
							value="{{ $query }}"
						@endisset placeholder="{{translate('Search in Sadar24.com...')}}" style="border-radius: 0;border-end-start-radius: 5px;border-start-start-radius: 5px;">
...
<style>
  ...
  <nav class=" navbar-expand-lg navbar-dark d-lg-none" style="color:whitesmoke; background-color: #131921;">
      <div class="w-100">
        <div class="row m-0">
          <div class="col-md-7 col-sm-6 col-7 text-light pl-4">
          ...
          <div class="col-md-5 col-sm-6 col-5 pl-0 pr-4 my-auto">
            <div style="width: 100%;" class="row ml-0">
          ...
          <div class="input-group">
            <form action="{{ route('search') }}" method="GET" class="stop-propagation" style="width:100%;">
				<div class="d-flex position-relative align-items-center">
					...
					<div class="input-group">
						<input type="text" class="form-control" id="mtags" name="keyword" @isset($query)
							value="{{ $query }}"
						@endisset placeholder="{{translate('Search in Sadar24.com...')}}" style="border-radius: 0;border-end-start-radius: 5px;border-start-start-radius: 5px;" >
						<button id="basic-addon1" type="submit" class=" input-group-text btn-primary" style="border-radius: 0;border-end-end-radius: 5px;border-start-end-radius: 5px;"><i class="fas fa-search"></i></button>
