                ...
                <div class="row">
                    <div class="col-12 px-0 mb-4" style="font-weight: 700;color: white;">
                        <ul class="footer_ul2_amrc"
                            ...
                            @endphp
                            @while ($status == 'true')
                                @if (get_setting('widget_' . $i . '_labels', null, App::getLocale()) != null)
                                        <li class="d-inline pl-2 font-weight-bolder">
                                            {{ get_setting('widget_' . $i, null, App::getLocale()) }} :</li>
                                        @foreach (json_decode(get_setting('widget_' . $i . '_labels', null, App::getLocale()), true) as $key => $value)
                                            <li class="d-inline px-2 border-right">
                                                <a
                                                    href="{{ json_decode(get_setting('widget_' . $i . '_links'), true)[$key] }}">
                                                    {{ $value }}
                                                </a>
                                            </li>
                                        @endforeach
                ...
                <div class="row m-0">
                    ...
                    <div class=" col-sm-6 col-md  col-12 col mb-4" style="font-weight: 700;color: white;">
                        ...
                        <ul class="footer_ul2_amrc"
                            style="font-weight: 100;font-size:14px; line-height: 1.8rem;color: #dddddb ;">
                            <li>
                                <span>{{ translate('Address') }}:
                                    {{ get_setting('contact_address', null, App::getLocale()) }}</span>
                            </li>
                            <li>
                            ...
                            <li>
                                <span>
                                    {{ translate('Email') }}: <a href="mailto:{{ get_setting('contact_email') }}"
                ...
                <ul class="social_footer_ul float-right border border-0">
                    @if (get_setting('payment_method_images') != null)
                        @foreach (explode(',', get_setting('payment_method_images')) as $key => $value)
                            <li><a class="border-0" href=""><img src="{{ uploaded_asset($value) }}" alt=""
    ...
    <div class="row align-items-center gutters-5">
        ...
        <div class="col">
            @if (Auth::check())
                ...
                @endif
            @else
                <a href="{{ route('user.otplogin') }}" class="text-reset d-block text-center pb-2 pt-3">
                    <span class="d-block mx-auto">
                        <img src="{{ static_asset('assets/img/avatar-place.png') }}"
                            class="rounded-circle size-20px">
                    </span>
