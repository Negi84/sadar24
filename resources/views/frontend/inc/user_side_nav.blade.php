            ...
            <ul class="aiz-side-nav-list px-2" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
				 ...
				 @if(Auth::user()->user_type == 'seller')
					<li class="aiz-side-nav-item">
						<a @if(Auth::user()->seller->verification_status == 1) disabled @endif href="{{ route('seller.products') }}" class="aiz-side-nav-link {{ areActiveRoutes(['seller.products', 'seller.products.upload', 'seller.products.edit'])}}">
							<i class="lab la-sketch aiz-side-nav-icon"></i>
							<span class="aiz-side-nav-text">{{ translate('Products') }}</span>
						</a>
					</li>
					<li class="aiz-side-nav-item">
						<a @if(Auth::user()->seller->verification_status == 1) disabled @endif href="{{route('product_bulk_upload.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['product_bulk_upload.index'])}}">
				...
				@php
                    ...
                    @if(Auth::user()->user_type == 'seller')
                        ...
                        @endphp
                        <li class="aiz-side-nav-item">
                            <a @if(Auth::user()->seller->verification_status == 1) disabled @endif href="{{ route('orders.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['orders.index'])}}">
                        ...
                        @if ($refund_request_addon != null && $refund_request_addon->activated == 1)
                            <li class="aiz-side-nav-item">
                                <a @if(Auth::user()->seller->verification_status == 1) disabled @endif href="{{ route('vendor_refund_request') }}" class="aiz-side-nav-link {{ areActiveRoutes(['vendor_refund_request','reason_show'])}}">
                                    <i class="las la-backward aiz-side-nav-icon"></i>
                        ...
                        <li class="aiz-side-nav-item">
                            <a @if(Auth::user()->seller->verification_status == 1) disabled @endif href="{{ route('payments.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['payments.index'])}}">
                        ...
                        <li class="aiz-side-nav-item">
                            <a @if(Auth::user()->seller->verification_status == 1) disabled @endif href="{{ route('withdraw_requests.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['withdraw_requests.index'])}}">
                        ...
                        <li class="aiz-side-nav-item">
                            <a @if(Auth::user()->seller->verification_status == 1) disabled @endif href="{{ route('commission-log.index') }}" class="aiz-side-nav-link">
                        ...
                        <li class="aiz-side-nav-item">
                            <a @if(Auth::user()->seller->verification_status == 1) disabled @endif href="{{ route('seller.brands') }}" class="aiz-side-nav-link {{ areActiveRoutes(['seller.brands'])}}">
                                <i class="las la-user aiz-side-nav-icon"></i>
                                <span class="aiz-side-nav-text">{{translate('Manage Brands')}}</span>
                            </a>
                        </li>
                    @endif
