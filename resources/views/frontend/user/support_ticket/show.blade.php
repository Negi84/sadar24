    ...
    <div class="card">
        <div class="card-header row gutters-5">
            <div class="text-center text-md-left">
                <h5 class="mb-md-0 h5">{{ $ticket->subject }} #{{ $ticket->code }}  <span class="badge badge-inline badge-secondary ml-2"> {{ ucfirst($ticket->status) }} </span></h5>
               <div class="mt-2">
					<p class="mt-2">
						<strong>Name : </strong>{{ $ticket->user->name }} <br>
