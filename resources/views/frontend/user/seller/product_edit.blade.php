            ...
            <div class="card">
                ...
                <div class="card-body">
					...
					<div class="form-group row" style="">
                        ...
                        <div class="col-lg-8">
                            <input type="number" lang="en" class="form-control" name="max_qty" value="@if($product->max_qty <= 1){{1}}@else{{$product->max_qty}}@endif" max="10" required>
                        </div>
                    </div>
                    <div class="form-group row">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-lg-6">
                    <input type="number" min="25" placeholder="{{translate('Unit price')}}" name="unit_price" class="form-control"
