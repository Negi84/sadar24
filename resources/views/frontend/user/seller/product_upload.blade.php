            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row" id="category">
                        ...
                        <div class="col-md-8">
                            <select class="form-control aiz-selectpicker" name="category_id" id="category_id"
                                data-live-search="true" onchange="update_tags()" required>
                    ...
                    <div class="form-group row" style="">
                        ...
                        <div class="col-lg-8">
                            <input type="number" lang="en" class="form-control" name="max_qty" value="10" max="50" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-8" >
                            <input type="text" class="form-control aiz-tag-input" name="tags[]"
								...
								<!--<select class="select2 form-control aiz-selectpicker" id="update_tag" name="tags[]" data-toggle="select2" data-placeholder="Choose ..."data-live-search="true" multiple>
								
								</select>
							<select class="select2 form-control aiz-selectpicker" name="tags[]" data-toggle="select2" data-placeholder="Choose ..."data-live-search="true" multiple>
                                
								@php
								/* $keywords = array();
								$products = \App\Product::select('tags')->where('published', 1)->where('category_id', 1)->get();
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="number" lang="en" min="25" value="0" step="0.01"
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control" name="est_shipping_days" min="1" step="1"
                                placeholder="{{translate('Shipping Days')}}" value="5">
                            <div class="input-group-prepend">
...
<script type="text/javascript">
    $("[name=shipping_type]").on("change", function (){
        ...
        $('input[name="unit_price"]').on('keyup', function() {
            console.log($('input[name="unit_price"]').val() < 25);
            if($('input[name="unit_price"]').val() < 25){
		...
		function update_tags(){
            ...
            $.ajax({
               type:"POST",
               url:'{{ route('products.update_tags') }}',
