                                ...
                                <div class="bg-white shadow-sm rounded mb-3">
                                    ...
                                    <div class="pl-3 pr-3 pb-3">
                                        <div class="aiz-range-slider">
                                            <div id="input-slider-range" data-range-value-min="@if (\App\Product::count() < 1) 0 @else {{ \App\Product::min('unit_price') }} @endif"
                                                data-range-value-max="@if (\App\Product::count() < 1) 0 @else {{ \App\Product::max('unit_price') }} @endif"></div>
                                                ...
                                                @foreach ($attribute->attribute_values as $attribute_value)
                                                    <label class="aiz-checkbox">
                                                        <input type="checkbox" name="selected_attribute_values[]"
                                                            ...
                                                            @if (in_array($attribute_value->value, $selected_attribute_values)) checked @endif onchange="filter()">
                                                ...
                                                @foreach ($colors as $key => $color)
                                                    <label class="aiz-megabox pl-0 mr-2" data-toggle="tooltip"
                                                        ...
                                                        <input type="radio" name="color" value="{{ $color->code }}"
                                                            onchange="filter()" @if (isset($selected_color) && $selected_color == $color->code) checked @endif>
                                                        <span
                            ...
                            <div class="d-flex align-items-center">
                                        ...
                                        <select class="form-control form-control-sm aiz-selectpicker"
                                            ...
                                            @foreach (\App\Brand::all() as $brand)
                                                <option value="{{ $brand->slug }}" @isset($brand_id)
                                                    @if ($brand_id == $brand->id) selected @endif @endisset>
                                ...
                                <div class="form-group w-200px ml-0 ml-xl-3">
                                    ...
                                    <select class="form-control form-control-sm aiz-selectpicker" name="sort_by"
                                        ...
                                        <option value="price-asc" @isset($sort_by)
                                            @if ($sort_by == 'price-asc') selected @endif @endisset>{{ translate('Price low to high') }}
                                        </option>
                                        <option value="price-desc" @isset($sort_by)
                                            @if ($sort_by == 'price-desc') selected @endif @endisset>{{ translate('Price high to low') }}
                                        </option>
                                    </select>
                                </div> 
