        ...
        <div class="container text-left">
            <div class="row">
                <div class="col-xl-8 mx-auto">
					...
					$state = json_decode($first_order->shipping_address)->state;
                    @endphp
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                        ...
                                        <table class="table table-responsive-md">
                                            ...
                                            <tbody>
												...
												@php
													...
													$product = \App\Product::select('category_id','user_id')->where('id', $product_id)->first();
													$category_id = $product->category_id;
													$category = \App\Category::select('gst')->where('id', $category_id)->first();
													$gstper = ($category->gst)/100;
													$gstval = $orderDetail->price * $gstper;
													//$orderDetail->price  = $orderDetail->price - $gstval;
													//$vendor_id = $product->user_id;
													//$product_shipping_cost = $orderDetail->shipping_cost;
													//$tax += ($product_shipping_cost * 0.18)* $orderDetail->quantity;
													//$shipping += $product_shipping_cost * $orderDetail->quantity;
													//$address_state = $orderDetail->order->address;
									...
									@php
										...
										$orderDetail->tax = $shiping_cost * 0.18;
										//$order->grand_total = $subtotal + $shiping_cost + $orderDetail->tax;
									@endphp
                                    <div class="row">
                                            ...
                                            <table class="table ">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <span class="font-italic">{{ single_price($shiping_cost) }}</span>
                                                        </td>
                                                    </tr>
                                                        ...
                                                        <th>{{ translate('Tax') }} </th>
                                                        <td class="text-right">
                                                            <span class="font-italic">{{ single_price($orderDetail->tax) }}</span>
                                                        </td>
                                                    </tr>
