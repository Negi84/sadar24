...
})(window,document,'script','dataLayer','GTM-K9PRS58');</script>
...
<body>
                ...
                $(el).click(function(){
                    if(!$(el).find('.sub-cat-menu').hasClass('loaded')){
                        $.post('{{ route('category.elements') }}', {_token: AIZ.data.csrf, id:$(el).data('id')}, function(data){
                            //alert("hello");
							//alert(data);
							document.getElementById("sub-container-content").innerHTML =data;
	...
	<script>
	  ...
	  $( function() {
		...
		$.post('{{ route('search.ajaxpred') }}', { _token: AIZ.data.csrf, search:searchKey}, function(data){
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K9PRS58"
