...
@if (DB::table('languages')->where('code', Session::get('locale', Config::get('app.locale')))->first()->rtl == 1)
    <html dir="rtl" lang="{{ str_replace('_', '-', app()->getLocale()) }}" style="overflow-x: hidden;">
@else
...
<head>
    ...
    {{-- <meta name="google-site-verification" content="5sTsQwRdatipVF-CvENDjOI3HqE7ZtTlAIw1ZxTsbOA" /> --}}
    @yield('meta')
    ...
    <link rel="stylesheet" href="{{ static_asset('assets/css/aksaku-style.css') }}">
    ...
    <!-- @if (request()->medium == 'metroapp' and request()->coupon == 'metro10')
		@php
