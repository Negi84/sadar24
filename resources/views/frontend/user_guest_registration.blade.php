                    ...
                    <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-8 mx-auto">
                        <div class="card">
                            ...
                            <div class="px-4 py-3 py-lg-4">
                                <div class="">
                                    <form id="reg-form" class="form-default" role="form" action="{{ route('user.guestRegister') }}" method="POST">
                                        @csrf
                                        ...
                                        @if (addon_is_activated('otp_system'))
                                            <div class="form-group phone-form-group mb-1" style="display:none;">
                                                <input type="hidden" id="phone-code" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" value="{{ old('phone') }}" placeholder="" name="phone" autocomplete="off">
                                            </div>
                                        ...
                                        @else
											<div class="form-group phone-form-group" style="display:none;">
                                                <input type="hidden" id="phone-code" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" value="{{ old('phone') }}" placeholder="" name="phone" autocomplete="off" required>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="mb-5">
                                            <button type="submit" class="btn btn-primary btn-block fw-600">{{  translate('Guest Login') }}</button>
                                        </div>
                                    </form>
