@php
    $best_selling_products = Cache::remember('best_selling_products', 8600, function () {
        return filter_products(\App\Product::where('published', 1)->inRandomOrder())->limit(20)->get();
            ...
            <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                <div class="d-flex mb-3 align-items-baseline border-bottom">
                    <h3 class="h5 fw-700 mb-0">
                        <span class="border-bottom border-primary border-width-2 pb-3 d-inline-block">{{ translate('What\'s Hot on Sadar 24') }}</span>
                    </h3>
