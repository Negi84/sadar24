                                        ...
                                        <li class="list-group-item px-0 px-lg-3">
                                            <div class="row gutters-5">
                                                <div class="col-lg-5 d-flex">
                                                    <a href="https://sadar24.com/product/{{ $product->getTranslation('slug') }}"
                                                        class="mr-2 ml-0"> <span class="mr-2 ml-0">
                                                    ...
                                                    <a
                                                        href="https://sadar24.com/product/{{ $product->getTranslation('slug') }}">
                                                        <span
                                                            class="fs-14 opacity-60">{{ $product_name_with_choice }}</span></a>
                                                </div>

                                                <div class="col-lg col-4 order-1 order-lg-0 my-3 my-lg-0">
                                                    <span
                                                        class="opacity-60 fs-12 d-block d-lg-none">{{ translate('Price') }}</span>
                                                    <span class="fw-600 fs-16">{{ single_price($unit_price) }}</span>
                                                </div>
                                                <div class="col-lg col-4 order-2 order-lg-0 my-3 my-lg-0">
                                                    <span
                                                        class="opacity-60 fs-12 d-block d-lg-none">{{ translate('Tax') }}</span>
                                                    <span class="fw-600 fs-16">{{ single_price($gst_tax) }}</span>
                                                </div>
