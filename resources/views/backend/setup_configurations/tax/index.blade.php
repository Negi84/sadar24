...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        ...
        <div class="col-md-6 text-md-right">
            <a href="#" data-bs-target="#add-tax" data-bs-toggle="modal" class="btn btn-circle btn-info">
...
@section('modal')
    <!-- Tax Add Modal -->
    <div id="add-tax" class="modal" role="dialog">
            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal"  action="{{ route('tax.store') }}" method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-styled btn-base-3" data-bs-dismiss="modal">
                            {{translate('Close')}}
                        </button>
