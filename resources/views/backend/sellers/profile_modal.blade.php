<div class="modal-body">
  ...
  <p><i class="demo-pli-map-marker-2 icon-lg icon-fw mr-1"></i>{{translate('Address')}} : {{ $seller->user->shop->address }}</p>
  <p><i class="demo-pli-map-marker-2 icon-lg icon-fw mr-1"></i>{{translate('Pickup Address')}} : {{ $seller->user->pickup_address }}</p>
  ...
  <p><i class="demo-pli-old-telephone icon-lg icon-fw mr-1"></i>{{ $seller->user->phone }}</p>
	...
	<p>{{translate('Bank Acc Type')}} : {{ $seller->account_type }}</p>
	<p>{{translate('Bank IFSC Code')}} : {{ $seller->ifsc_code }}</p>
	<p>{{translate('Bank Branch')}} : {{ $seller->branch }}</p>
  <br>
