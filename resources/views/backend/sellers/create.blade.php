            ...
            <div class="card-body">
                <form action="{{ route('sellers.store') }}" method="POST">
                    ...
                    <div class="row">
						<div class="col-md-5">
                            <div class="form-group">
                                <label>{{ translate('Company Address') }} <span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="col-form-label">{{ translate('bank_name') }} <span
                                        class="text-danger text-danger">*</span></label>
                                <input type="text" placeholder="{{ translate('bank_name') }}" id="bank_name"
                                    class="form-control" name="bank_name" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="col-form-label">{{ translate('bank_acc_name') }} <span
                                        class="text-danger text-danger">*</span></label>
                                <input type="text" placeholder="{{ translate('bank_acc_name') }}" id="bank_acc_name"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="col-form-label">{{ translate('Branch') }} <span
                                        class="text-danger text-danger">*</span></label>
                                <input type="text" placeholder="{{ translate('Branch') }}" id="branch"
                                    class="form-control mb-3" name="branch" required>
                            </div>
                        </div>
                    </div>
