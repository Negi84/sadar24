            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <select class="select2 form-control aiz-selectpicker" name="parent_id" data-toggle="select2" data-placeholder="Choose ..." data-live-search="true" required>
					...
					<div class="form-group row">
						...
						<div class="col-md-9 input-group">
							<input type="number" lang="en" min="0" step="0.01" placeholder="{{translate('GST Percentage')}}" id="gst" name="gst" class="form-control">
					...
					<div class="form-group row">
						...
						<div class="col-md-9 input-group">
							  <input type="text" placeholder="{{translate('HSN Code')}}" id="hsn" name="hsn" class="form-control">
						</div>
					</div>
                    <div class="form-group row">
