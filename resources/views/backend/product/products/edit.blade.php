                ...
                <div class="card">
                    ...
                    <div class="card-body">
						...
						<div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="number" lang="en" class="form-control" name="max_qty" value="{{ $product->max_qty }}">
                            </div>
                        </div>
                        <div class="form-group row">
...
<!--                <div class="card">
            ...
            <div class="col-lg-4">
                ...
                <div class="card" style="display:none;">
                    <div class="card-header">
                        <h5 class="mb-0 h6" class="dropdown-toggle" data-toggle="collapse" data-bs-target="#collapse_2">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('GST Percentage')}}</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <input type="text" lang="en" min="0" value="{{ $tax_amount }}" step="0.01" placeholder="{{ translate('Tax') }}" name="tax[]" class="form-control" required>
                            </div>
                            <div class="form-group col-md-6">
