        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('filters.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-from-label">{{translate('Filter Attributes')}} <span class="text-danger">*</span></label>
                        <div class="col-md-9">
                            <input type="text" class="form-control aiz-tag-input" name="filterAttributes[]" placeholder="{{ translate('Type and hit enter to add a tag') }}">
