        ...
        <div class="clearfix float-right">
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <strong class="text-muted">{{translate('Shipping GST')}} :</strong>
                        </td>
                        <td>
                    ...
                    @if ($order->payment_type == "razorpay" && $order->device_type == "mobile")
                    <tr>
                        <td>
                            <strong class="text-muted">{{translate('Online Discount')}} :</strong>
                        </td>
                        <td>
                            {{ single_price(20) }}
                        </td>
