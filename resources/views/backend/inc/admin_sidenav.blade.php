<div class="aiz-sidebar-wrap">
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('filters.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['filters.index', 'filters.create', 'filters.edit'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Filter and Keywords')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{route('categories.featured_categories')}}" class="aiz-side-nav-link {{ areActiveRoutes(['categories.featured_categories', 'categories.create', 'categories.edit'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Featured Categories')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('5', json_decode(Auth::user()->staff->role->permissions)))
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('seller_orders.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['seller_orders.index', 'seller_orders.show'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Seller Wise Orders')}}</span>
                                </a>
                            </li>
                        @endif
                        @if(Auth::user()->user_type == 'admin' || in_array('5', json_decode(Auth::user()->staff->role->permissions)))
                        <li class="aiz-side-nav-item">
							<a href="{{ route('seller_account.index') }}" class="aiz-side-nav-link">
								<span class="aiz-side-nav-text">{{ translate('Seller Account') }}</span>
							</a>
						</li>
						 @endif
                    ...
                    @if(Auth::user()->user_type == 'admin' || in_array('7', json_decode(Auth::user()->staff->role->permissions)))
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('categories_refund_time_config')}}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{translate('Categories Refund Configuration')}}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('customers.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('All Customer list') }}</span>
                                </a>
                            </li>
                            ...
                            @endif
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('customers.registered_index') }}" class="aiz-side-nav-link">
                            ...
                            @endif
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('customers.guest_index') }}" class="aiz-side-nav-link">
                ...
                @if((Auth::user()->user_type == 'admin' || in_array('9', json_decode(Auth::user()->staff->role->permissions))) && get_setting('vendor_system_activation') == 1)
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
							...
							<li class="aiz-side-nav-item">
                                <a href="{{ route('business_settings.sla_charge') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Seller Breach Setting') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('10', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
							...
							<li class="aiz-side-nav-item">
                                <a href="{{ route('seller_registration_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['seller_registration_report.index'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('Seller Registration') }}</span>
                                </a>
                            </li>							
							<li class="aiz-side-nav-item">
                                <a href="{{ route('customer_registration_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['customer_registration_report.index'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('All Customer Registration') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('registered_customer_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['registered_customer_report.index'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('Registered Customer') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('guest_customer_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['guest_customer_report.index'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('Guest Customer') }}</span>
                                </a>
                            </li>
							<li class="aiz-side-nav-item">
                                <a href="{{ route('sales_reports.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['sales_reports.index'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('Sales Reports') }}</span>
                                </a>
                            </li>
							<li class="aiz-side-nav-item">
                                <a href="{{ route('best_selling_products_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['best_selling_products_report.index'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('Best Selling Products') }}</span>
                                </a>
                            </li>							
							<li class="aiz-side-nav-item">
                                <a href="{{ route('coupon_code_utilization_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['coupon_code_utilization_report.index'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('Coupon Code Utilization') }}</span>
                                </a>
                            </li>							
                            <li class="aiz-side-nav-item">
							...
							<li class="aiz-side-nav-item">
                                <a href="{{ route('recently_viewed_report.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Recently Viewed Items') }}</span>
                                </a>
                            </li>
							@if(get_setting('sla_activation') == 1)
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('sla_breach_report.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('SLA Breach Report') }}</span>
                                </a>
                            </li>
                            @endif
                        </ul>
            ...
            <li class="aiz-side-nav-item">
                <a href="#" class="aiz-side-nav-link {{ areActiveRoutes(['mobileapp.home_layout'])}}" >
                    <i class="las la-desktop aiz-side-nav-icon"></i>
                ...
                <ul class="aiz-side-nav-list level-2">
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('mobileapp.home_layout') }}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{translate('Home screen layout')}}</span>
                        </a>
                    </li>
                </ul>
            </li>
