    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-bs-dismiss="modal"><?php echo e(translate('Cancel')); ?></button>
                <a id="delete_link" class="btn btn-danger btn-ok"><?php echo e(translate('Delete')); ?></a>
            </div>
        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\sadar24\resources\views/frontend/partials/modal.blade.php ENDPATH**/ ?>