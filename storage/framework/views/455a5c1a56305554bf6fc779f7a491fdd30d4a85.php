    ...
    <?php if(isset($cart) && count($cart) > 0): ?>
        ...
        <div class="px-3 py-2 text-center border-top">
            <ul class="list-inline mb-0">
                ...
                <?php if(Auth::check()): ?>
                <li class="list-inline-item">
                    <a href="<?php echo e(route('checkout.view_checkout')); ?>" class="btn btn-primary btn-sm">
...
<?php /**PATH C:\xampp\htdocs\sadar24\resources\views/frontend/partials/cart.blade.php ENDPATH**/ ?>