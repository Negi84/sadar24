    ...
    <div class="position-relative">
        <a href="<?php echo e(route('product', $product->slug)); ?>" class="d-block">
            <img class="img-fit lazyload mx-auto h-140px h-md-210px" style="object-fit: contain;" 
                src="<?php echo e(static_asset('assets/img/placeholder.jpg')); ?>" data-src="<?php echo e(uploaded_asset($photos[0] == 0 ? $photos[1] : $photos[0])); ?>"
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\sadar24\resources\views/frontend/partials/product_box_1.blade.php ENDPATH**/ ?>