<!DOCTYPE html>
<?php if(DB::table('languages')->where('code', Session::get('locale', Config::get('app.locale')))->first()->rtl == 1): ?>
    <html dir="rtl" lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" style="overflow-x: hidden;">
<?php else: ?>
    <html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" style="overflow-x: hidden;">
<?php endif; ?>
...
<head>
    ...
    <meta name="google-site-verification" content="RCfdbbeaUEHBekXf4i88Ocyb1X0NjD94Q_bQkCHuOfM" />
    ...
    <link rel="stylesheet" href="<?php echo e(static_asset('assets/css/aksaku-style.css')); ?>">
    ...
    <?php if(get_setting('google_analytics') == 1): ?>
        ...
        <?php endif; ?>
        <!-- Global site tag (gtag.js) - Google Analytics 2022-5-31 -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-BNE1196GGG"></script>
        <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'G-BNE1196GGG');
        </script>
    ...
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-K9PRS58');
    </script>
    <!-- End Google Tag Manager -->

    <!-- Global site tag (gtag.js) - Google Ads: 408007506 -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=AW-408007506"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        ...
        gtag('config', 'AW-408007506');
    </script>


    <!-- <?php if(request()->medium == 'metroapp' and request()->coupon == 'metro10'): ?>
		<?php

		Session::put('medium_value', request()->medium);
		Session::put('coupon_value', request()->coupon);
		?>
		<?php endif; ?>	 
...
<body>
                    ...
                    if (!$(el).find('.sub-cat-menu').hasClass('loaded')) {
                        $.post('<?php echo e(route('category.elements')); ?>', {
                            ...
                            document.getElementById("sub-container-content").innerHTML =
                                data;
                            //$(el).find('#sub-container-content').html(data);
                        });
                    }
                });
            });
    ...
    <script>
        $(function() {
            ...
            $.post('<?php echo e(route('search.ajaxpred')); ?>', {
                _token: AIZ.data.csrf,
                search: searchKey
            }, function(data) {
                availableTags = data;
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K9PRS58" height="0" width="0"
            style="display:none;visibility:hidden"></iframe></noscript>
    <!-- End Google Tag Manager (noscript) -->

</body>

</html><?php /**PATH C:\xampp\htdocs\sadar24\resources\views/frontend/layouts/app.blade.php ENDPATH**/ ?>