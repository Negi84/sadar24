<div class="aiz-sidebar-wrap">
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
                ...
                <?php if(Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions))): ?>
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('filters.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['filters.index', 'filters.create', 'filters.edit'])); ?>">
                                    <span class="aiz-side-nav-text"><?php echo e(translate('Filter and Keywords')); ?></span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('categories.featured_categories')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['categories.featured_categories', 'categories.create', 'categories.edit'])); ?>">
                                    <span class="aiz-side-nav-text"><?php echo e(translate('Featured Categories')); ?></span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                        ...
                        <?php if(Auth::user()->user_type == 'admin' || in_array('5', json_decode(Auth::user()->staff->role->permissions))): ?>
                            <li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('seller_orders.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['seller_orders.index', 'seller_orders.show'])); ?>">
                                    <span class="aiz-side-nav-text"><?php echo e(translate('Seller Wise Orders')); ?></span>
                                </a>
                            </li>
                        <?php endif; ?>
                        <?php if(Auth::user()->user_type == 'admin' || in_array('5', json_decode(Auth::user()->staff->role->permissions))): ?>
                        <li class="aiz-side-nav-item">
							<a href="<?php echo e(route('seller_account.index')); ?>" class="aiz-side-nav-link">
								<span class="aiz-side-nav-text"><?php echo e(translate('Seller Account')); ?></span>
							</a>
						</li>
						 <?php endif; ?>
                ...
                <?php if(addon_is_activated('delivery_boy')): ?>
                    <?php if(Auth::user()->user_type == 'admin' || in_array('1', json_decode(Auth::user()->staff->role->permissions))): ?>
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                <li class="aiz-side-nav-item">
                                    <a href="<?php echo e(route('delivery-boys.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['delivery-boys.index'])); ?>">
                                        <span class="aiz-side-nav-text"><?php echo e(translate('All Delivery Boy')); ?></span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="<?php echo e(route('delivery-boys.create')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['delivery-boys.create'])); ?>">
                                        <span class="aiz-side-nav-text"><?php echo e(translate('Add Delivery Boy')); ?></span>
                                    </a>
                                </li>
                                
                                <li class="aiz-side-nav-item">
                                    <a href="<?php echo e(route('delivery-boy.cancel-request')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['delivery-boy.cancel-request'])); ?>">
                    ...
                    <?php if(Auth::user()->user_type == 'admin' || in_array('7', json_decode(Auth::user()->staff->role->permissions))): ?>
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="<?php echo e(route('categories_refund_time_config')); ?>" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text"><?php echo e(translate('Categories Refund Configuration')); ?></span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('customers.index')); ?>" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text"><?php echo e(translate('All Customer list')); ?></span>
                                </a>
                            </li>
                            ...
                            <?php endif; ?>
                            <li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('customers.registered_index')); ?>" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text"><?php echo e(translate('Register Customer list')); ?></span>
                                </a>
                            </li>
                            <?php if(get_setting('classified_product') == 1): ?>
                                <li class="aiz-side-nav-item">
                            ...
                            <?php endif; ?>
                            <li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('customers.guest_index')); ?>" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text"><?php echo e(translate('Guest Customer list')); ?></span>
                                </a>
                            </li>
                            <?php if(get_setting('classified_product') == 1): ?>
                                <li class="aiz-side-nav-item">
                ...
                <?php if(Auth::user()->user_type == 'admin' || in_array('10', json_decode(Auth::user()->staff->role->permissions))): ?>
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
							...
							<li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('seller_registration_report.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['seller_registration_report.index'])); ?>">
                                    <span class="aiz-side-nav-text"><?php echo e(translate('Seller Registration')); ?></span>
                                </a>
                            </li>							
							<li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('customer_registration_report.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['customer_registration_report.index'])); ?>">
                                    <span class="aiz-side-nav-text"><?php echo e(translate('All Customer Registration')); ?></span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('registered_customer_report.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['registered_customer_report.index'])); ?>">
                                    <span class="aiz-side-nav-text"><?php echo e(translate('Registered Customer')); ?></span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('guest_customer_report.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['guest_customer_report.index'])); ?>">
                                    <span class="aiz-side-nav-text"><?php echo e(translate('Guest Customer')); ?></span>
                                </a>
                            </li>
							<li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('sales_reports.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['sales_reports.index'])); ?>">
                                    <span class="aiz-side-nav-text"><?php echo e(translate('Sales and Best Perfoming Reports')); ?></span>
                                </a>
                            </li>
							<li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('best_selling_products_report.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['best_selling_products_report.index'])); ?>">
                                    <span class="aiz-side-nav-text"><?php echo e(translate('Best Selling Products')); ?></span>
                                </a>
                            </li>							
							<li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('coupon_code_utilization_report.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['coupon_code_utilization_report.index'])); ?>">
                                    <span class="aiz-side-nav-text"><?php echo e(translate('Coupon Code Utilization')); ?></span>
                                </a>
                            </li>
							<li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('day_book_report.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['day_book_report.index'])); ?>">
                                    <span class="aiz-side-nav-text"><?php echo e(translate('Day Book Download ')); ?></span>
                                </a>
                            </li>
            ...
            <li class="aiz-side-nav-item">
                <a href="#" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['mobileapp.home_layout'])); ?>" >
                    <i class="las la-desktop aiz-side-nav-icon"></i>
                    <span class="aiz-side-nav-text"><?php echo e(translate('App Setup')); ?></span>
                    <span class="aiz-side-nav-arrow"></span>
                </a>
                <ul class="aiz-side-nav-list level-2">
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('mobileapp.home_layout')); ?>" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Home screen layout')); ?></span>
                        </a>
                    </li>
                </ul>
            </li>
...
<?php /**PATH /var/www/sadar24_aws/resources/views/backend/inc/admin_sidenav.blade.php ENDPATH**/ ?>