                    ...
                    <tr>
                        ...
                        <td><?php if($coupon->type == 'cart_base'): ?>
							...
							<?php elseif($coupon->type == 'category_base'): ?>
                                <?php echo e(translate('Category Base')); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sadar24_aws/resources/views/backend/marketing/coupons/index.blade.php ENDPATH**/ ?>