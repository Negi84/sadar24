                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <div class="aiz-checkbox-inline">
                                        <label class="aiz-checkbox">
                                            <input type="checkbox" class="check-one" name="id[]" value="<?php echo e($seller->id); ?>">
                                            <span class="aiz-square-check"></span>
                                        </label>
                                    </div>
                                </div>
...
<?php $__env->startSection('modal'); ?>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-light" data-bs-dismiss="modal"><?php echo e(translate('Cancel')); ?></button>
	...
	<!-- Unban Seller Modal -->
	<div class="modal" id="confirm-unban">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title h6"><?php echo e(translate('Confirmation')); ?></h5>
    ...
    <script type="text/javascript">
        ...
        function update_approved(el){
            ...
            $.post('<?php echo e(route('sellers.approved')); ?>', {_token:'<?php echo e(csrf_token()); ?>', id:el.value, status:status}, function(data){
                console.log(data);
                if(data.status == 1){
                    AIZ.plugins.notify('success', '<?php echo e(translate('Seller Approved successfully')); ?>');
                    ...
                    AIZ.plugins.notify('success', '<?php echo e(translate('Seller Disapproved successfully')); ?>');
                      if(data.api_status == 0){
                    AIZ.plugins.notify('danger', data.message);
                    }else{
                    AIZ.plugins.notify('success', data.message);
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sadar24_aws/resources/views/backend/sellers/index.blade.php ENDPATH**/ ?>