                                        ...
                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:30px 20px 20px;font-family:'Lato',sans-serif;"
                                            ...
                                            <div
                                                ...
                                                <p style="font-size: 14px; line-height: 120%;"><strong><span
                                                            ...
                                                            <?php echo e($shipping_address->name); ?></span></strong></p>
                                            </div>
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 20px 30px;font-family:'Lato',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 160%;"><span
                                                                        ...
                                                                        <?php echo e($shipping_address->name); ?></span></p>
                                                                <p style="font-size: 14px; line-height: 160%;"><span
                                                                        style="font-size: 14px; line-height: 22.4px;"><?php echo e($shipping_address->address); ?>,
                                                                        <?php echo e($shipping_address->city); ?>,</span></p>
                                                                <p style="font-size: 14px; line-height: 160%;"><span
                                                                        style="font-size: 14px; line-height: 22.4px;"><?php echo e($shipping_address->postal_code); ?>,
                                                                        <?php echo e($shipping_address->state); ?>,
                                                                        <?php echo e($shipping_address->country); ?></span></p>
                                                            </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 120%;"><span
                                                                        style="font-size: 20px; line-height: 24px;"><strong>Number:
                                                                            <?php echo e($order->code); ?></strong></span></p>
                                                                <p style="font-size: 14px; line-height: 120%;"><span
                                                                        style="font-size: 20px; line-height: 24px;"><strong>Date:
                                                                            <?php echo e(date('d-m-Y', $order->date)); ?></strong></span>
                                                                </p>
                                                            </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 120%;"><span
                                                                        style="font-size: 24px; line-height: 28.8px;"><strong><span
                                                                                style="line-height: 28.8px; font-size: 18px;"><?php echo e(single_price($order->orderDetails->sum('price'))); ?></span></strong></span>
                                                                </p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 20px 20px;font-family:'Lato',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 120%;"><span
                                                                        style="font-size: 24px; line-height: 28.8px;"><strong><span
                                                                                style="line-height: 28.8px; font-size: 18px;"><?php echo e(single_price($shiping_cost)); ?></span></strong></span>
                                                                </p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 20px 20px;font-family:'Lato',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 120%;"><span
                                                                        style="font-size: 24px; line-height: 28.8px;"><strong><span
                                                                                style="line-height: 28.8px; font-size: 18px;"><?php echo e(single_price($order->coupon_discount)); ?></span></strong></span>
                                                                </p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:35px 20px 20px;font-family:'Lato',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 120%;">
                                                                    <strong><span
                                                                            style="font-size: 24px; line-height: 36px;"><?php echo e(single_price($order->grand_total)); ?></span></strong>
                                                                </p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 20px 20px;font-family:'Lato',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 120%;"><span
                                                                        style="font-size: 24px; line-height: 28.8px;"><strong><span
                                                                                style="line-height: 28.8px; font-size: 18px;"><?php echo e(single_price($round_of_amount)); ?></span></strong></span>
                                                                </p>
                                                            </div>
...
<?php /**PATH /var/www/sadar24_aws/resources/views/emails/userinvoice.blade.php ENDPATH**/ ?>