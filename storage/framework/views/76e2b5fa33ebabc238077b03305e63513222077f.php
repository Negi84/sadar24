<div class="modal-body p-4 added-to-cart">
    ...
    <div class="text-center">
        <button class="btn btn-outline-primary mb-3 mb-sm-0" data-bs-dismiss="modal"><?php echo e(translate('Back to shopping')); ?></button>
        <a href="<?php echo e(route('cart')); ?>" class="btn btn-primary mb-3 mb-sm-0"><?php echo e(translate('Proceed to Checkout')); ?></a>
    </div>
</div>
<script type="text/javascript">   
	var option = "<?php echo route('product', $product->slug); ?> ?>";
	wigzo("track", "addtocart", option);
</script><?php /**PATH /var/www/sadar24_aws/resources/views/frontend/partials/addedToCart.blade.php ENDPATH**/ ?>