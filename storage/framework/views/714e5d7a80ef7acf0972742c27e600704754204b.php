                ...
                <?php $__currentLoopData = $refunds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $refund): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            <a class="btn btn-soft-danger btn-icon btn-circle btn-sm" onclick="reject_refund_request('<?php echo e(route('reject_reason_show', $refund->id )); ?>', '<?php echo e($refund->id); ?>', '<?php echo e($refund->order->code); ?>')"  title="<?php echo e(translate('Reject Refund Request')); ?>">
...
<?php $__env->startSection('modal'); ?>
  <div class="modal reject_refund_request" id="modal-basic">
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sadar24_aws/resources/views/refund_request/index.blade.php ENDPATH**/ ?>